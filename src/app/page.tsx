        ...
        <div className="flex gap-5 items-stretch flex-col md:flex-row">
          <div className="flex-1 bg-gray-700 border-gray-600 rounded-2xl p-8 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm md:text-base">
              ...
              <strong>
                {" "}
                SE VC TA LENDO ISSO SOCRRO EU NAO AGUANETOE MAIS FAZER MPRGORMA
              </strong>
              <br />
              <br />
          ...
          <form className="bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-8 w-full md:max-w-[440px]">
            <h2 className="font-heading font-semibold text-gray-200 text-xl">
              Inscrição
            </h2>
