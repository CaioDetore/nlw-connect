  ...
  return (
    <div className="grid gap-3 md:grid-cols-3">
      <div className="bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl relative">
        ...
        <MousePointerClick className="size-5 text-purple absolute top-3 left-2" />
      </div>
      ...
      <div className="bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl relative">
        ...
        <BadgeCheck className="size-5 text-purple absolute top-3 left-2" />
      </div>
      ...
      <div className="bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl relative">
        ...
        <Medal className="size-5 text-purple absolute top-3 left-2" />
      </div>
    </div>
  );
}
